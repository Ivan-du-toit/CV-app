<h2 class="sub_title">Results for {{term}}</h2>
<span ng-show="occupations.length != 0"><h4>Occupations:</h4></span>
<ul class="items">
...
<span ng-show="projects.length != 0"><h4>Projects:</h4></span>
<ul class="items">
...
<span ng-show="metas.length != 0"><h4>Data:</h4></span>
<ul class="items">
